...
function resetRace() {
  ...
  $("#approachGuide").hidden = false;
  $("#approachGuide").className = "approach-guide";
...
function updateApproach(now, dt) {
  ...
  $("#approachGuide").className = `approach-guide ${predictedTiming >= 0 && predictedTiming < 1 ? "good" : "danger"}`;
  if (untilStart > 0) {
